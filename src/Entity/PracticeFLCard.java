...
public class PracticeFLCard extends BaseEntity<PracticeFLCard>{
	...
	public PracticeFLCard() {
		super();
	}
	public PracticeFLCard(String question, String option1, String option2, String option3, String option4,
			String optioncorrect, String optionuselect) {
		super();
